...
#define PIN_RF_RX_DATA_0 D3        // On this input, the 433Mhz-RF signal is received. LOW when no signal.
#define PIN_RF_TX_PMOS_0 NOT_A_PIN // High Side P-MOSFET, active on LOW level
#define PIN_RF_TX_NMOS_0 D6        // Low Side N-MOSFET, active on HIGH level
...
#ifdef ESP32
#define PIN_RF_RX_PMOS NOT_A_PIN_0 // High Side P-MOSFET, active on LOW level
#define PIN_RF_RX_NMOS NOT_A_PIN_0 // Low Side N-MOSFET, active on HIGH level
#define PIN_RF_RX_VCC NOT_A_PIN_0  // Power to the receiver on this pin
#define PIN_RF_RX_GND NOT_A_PIN_0  // Ground to the receiver on this pin
#define PIN_RF_RX_NA NOT_A_PIN_0   // Alt. RX_DATA. Forced as input
#define PIN_RF_RX_DATA NOT_A_PIN_0 // On this input, the 433Mhz-RF signal is received. LOW when no signal.
#define PIN_RF_TX_PMOS NOT_A_PIN_0 // High Side P-MOSFET, active on LOW level
#define PIN_RF_TX_NMOS NOT_A_PIN_0 // Low Side N-MOSFET, active on HIGH level
#define PIN_RF_TX_VCC NOT_A_PIN_0  // +5 volt / Vcc power to the transmitter on this pin
#define PIN_RF_TX_GND NOT_A_PIN_0  // Ground power to the transmitter on this pin
#define PIN_RF_TX_DATA NOT_A_PIN_0 // Data to the 433Mhz transmitter on this pin
#endif
