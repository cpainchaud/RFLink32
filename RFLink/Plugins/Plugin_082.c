 ...
 * Pulses=26;Pulses(uSec)=475,300,325,700,325,700,325,700,325,700,725,300,725,300,725,300,725,300,725,300,325,700,725,300,725;
 \*********************************************************************************************/
#define MAXITROL2_PLUGIN_ID 082
#define PLUGIN_DESC_082 "Mertik v2"
...
boolean Plugin_082(byte function, const char *string)
{
   ...
   // Get all 22 bits
   //==================================================================================
   for (int x = 3; x < MAXITROL2_PULSECOUNT + 1; x += 2)
   {
...
boolean  PluginTX_082(byte function, const char *string)
{
