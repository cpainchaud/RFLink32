...
//
#define BUILDNR 0x07                    // 0x07       // shown in version
#define REVNR 0x42                      // 0X42       // shown in version and startup string
...
#define SIGNAL_END_TIMEOUT_US 4500      // 4500       // After this time in uSec. the RF signal will be considered to have stopped.
